...
<div id="kk-section" style="display:none" class="mb-6">
    <div class="flex items-center justify-between mb-4">
        ...
        <span id="kk-scope" class="text-xs font-bold text-slate-400 bg-slate-50 border border-slate-100 px-3 py-1.5 rounded-full"></span>
    </div>

    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">

        {{-- Total Karyawan --}}
        <button type="button" data-kk="total" class="kk-card text-left bg-white rounded-[1.5rem] p-5 shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-slate-100 flex items-center gap-4 hover:shadow-md hover:-translate-y-0.5 transition">
        ...
        {{-- Sudah Hadir --}}
        <button type="button" data-kk="hadir" class="kk-card text-left bg-white rounded-[1.5rem] p-5 shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-slate-100 flex items-center gap-4 hover:shadow-md hover:-translate-y-0.5 transition">
        ...
        {{-- Terlambat --}}
        <button type="button" data-kk="terlambat" class="kk-card text-left bg-white rounded-[1.5rem] p-5 shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-slate-100 flex items-center gap-4 hover:shadow-md hover:-translate-y-0.5 transition">
        ...
        {{-- Belum Absen --}}
        <button type="button" data-kk="belum" class="kk-card text-left bg-white rounded-[1.5rem] p-5 shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-slate-100 flex items-center gap-4 hover:shadow-md hover:-translate-y-0.5 transition">
        ...
        <div class="bg-white rounded-[1.5rem] p-5 shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-slate-100 flex items-center gap-4">
            <div class="w-12 h-12 bg-indigo-50 text-indigo-500 rounded-xl flex items-center justify-center shrink-0"><i data-lucide="moon" class="w-6 h-6"></i></div>
            <div>
    ...
    <p class="text-[11px] text-slate-400 mt-3">Klik kartu <span class="font-semibold">Total / Sudah Hadir / Terlambat / Belum Absen</span> untuk melihat daftar nama & unit karyawan.</p>
</div>
...
<div id="kk-modal" style="display:none" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[80vh] flex flex-col">
        <div class="flex items-center justify-between px-5 py-4 border-b border-slate-100">
            ...
            <button type="button" id="kk-modal-close" class="text-slate-400 hover:text-slate-700 text-2xl leading-none">&times;</button>
        </div>
